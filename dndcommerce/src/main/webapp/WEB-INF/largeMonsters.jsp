	...
	<div class="container">
		<div class="banner">
			<div class="d-flex justify-content-between align-items-center">
				<h1 > <a class="noLine elden" href="/main" > DND Miniatures</a></h1>
				<c:choose>
					<c:when test = "${userId == null}">
						<h5 class="d-flex">
							<a class="mx-2 noLine white" href="/wishlist"> WishList</a>
							<a class="mx-2 noLine white" href="/cart"> Cart</a>
							<a class="mx-2 noLine white" href="/"> Register/Login</a>
						</h5>
					</c:when>
					<c:otherwise>
						<h5 class="d-flex">
		...
		<h3 class="center elden bg-dark">Large Monsters</h3>
		<div class="product-grid">
			<c:forEach var="item" items="${items}">
				<c:if test="${item.group.id == 2}">
					<div class="col-3 section">
						...
						<c:choose>
							<c:when test = "${userId != null}">						
								<div class="buttons">
									<form:form action="/cart/add/large" method="post" modelAttribute="cart">
									...
									<form:form action="/wishlist/add/large" method="post" modelAttribute="wish">
										<form:hidden path="user" value="${userId}" />
										<form:hidden path="item" value="${item.id}" />
