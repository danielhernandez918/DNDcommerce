...
<body>
	<div class="container">
		...
		<h3 class="center elden bg-dark">Individuals</h3>
		<div class="product-grid">
			<c:forEach var="item" items="${items}">
				<c:if test="${item.group.id == 1}">
					<div class="col-3 section">
						...
						<c:choose>
							<c:when test = "${userId != null}">
								<div class="buttons">
									<form:form action="/cart/add/indi" method="post" modelAttribute="cart">
									...
									<form:form action="/wishlist/add/indi" method="post" modelAttribute="wish">
										<form:hidden path="user" value="${userId}" />
										<form:hidden path="item" value="${item.id}" />
